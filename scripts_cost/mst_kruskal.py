...
# screen -S mst_kruskal -dm -L -Logfile screenlog_mst_kruskal.0 sh -c 'time /usr/bin/python3 scripts_cost/mst_kruskal.py 0'
# screen -S mst_kruskal_est -dm -L -Logfile screenlog_mst_kruskal_est.0 sh -c 'time /usr/bin/python3 scripts_cost/mst_kruskal.py 1'

print(
"\n \
1. Enter: ~/mst_query_optimization\n \
2. Run the following command: /usr/bin/python3 scripts_cost/mst_kruskal.py arg1\n \
...
if len(sys.argv) != 2:
    ...
    try:
        ...
        if cardinality_idx not in [0, 1]: 
            ...
            output_f_file = "output_data/job/costs/kruskal_opt_plans"
