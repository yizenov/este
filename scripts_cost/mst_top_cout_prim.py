...
# screen -S mst_top_cout_prim -dm -L -Logfile screenlog_mst_top_cout_prim.0 sh -c 'time /usr/bin/python3 scripts_cost/mst_top_cout_prim.py'

print(
"\n \
1. Enter: ~/mst_query_optimization\n \
2. Run the following command: /usr/bin/python3 scripts_cost/mst_top_cout_prim.py\n \
...
if len(sys.argv) != 1:
    ...
    try:
        ...
        if cardinality_idx not in [0, 1]: 
            ...
            output_f_file = "output_data/topology/costs_cout/prim_opt_plans.csv"
